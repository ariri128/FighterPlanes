...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject enemyTwoPrefab; // added code
    public GameObject cloudPrefab;
    public GameObject gameOverText;
    public GameObject restartText;
    public GameObject powerupPrefab;
    public GameObject coinPrefab; // added code
    public GameObject audioPlayer;

    public AudioClip powerupSound;
    public AudioClip powerdownSound;
    public AudioClip coinSound; // added code
    ...
    void Start()
    {
        ...
        InvokeRepeating("CreateEnemyTwo", 3, 7); // added code
        StartCoroutine(SpawnPowerup());
        StartCoroutine(SpawnCoin()); // added code
    ...
    void CreateCoin()
    {
        Instantiate(coinPrefab, new Vector3(Random.Range(-9f, 9f), Random.Range(0, -3.5f), 0), Quaternion.identity);
    }
